...
void OBCameraNode::setupPublishers() {
  ...
  if (enable_point_cloud_) {
    ...
    depth_cloud_pub_ = nh_.advertise<sensor_msgs::PointCloud2>(
        camera_name_ + "/depth/points", 1, depth_cloud_subscribed_cb, depth_cloud_unsubscribed_cb); 
  ...
  if (enable_colored_point_cloud_) {
    ...
    depth_registered_cloud_pub_ = nh_.advertise<sensor_msgs::PointCloud2>(
        camera_name_ + "/depth_registered/points", 1, depth_registered_cloud_subscribed_cb,
