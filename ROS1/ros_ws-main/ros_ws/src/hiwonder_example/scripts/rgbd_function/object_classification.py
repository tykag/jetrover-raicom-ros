...
class ObjectClassificationNode:
    ...
    def goto_default(self):
        endpoint = kinematics_control.set_joint_value_target([500, 470, 220, 90, 500])
        pose_t = endpoint.pose.position
        pose_r = endpoint.pose.orientation
        bus_servo_control.set_servos(self.servos_pub, 1, ((1, 500), (2, 470), (3, 220), (4, 90), (5, 500), (10, 200)))
